...
def run_network(inputs, viewdirs, fn, embed_fn, embeddirs_fn, netchunk=1024*64):
    ...
    #print("inputs Shape:",inputs.size(),"input_flat Shape:",inputs_flat.size())
    ...
    #print("embedded Shape after cat:", embedded.size())


    outputs_flat = batchify(fn, netchunk)(embedded)
    #print("outputs_flat shape:",outputs_flat.size())
...
def train():
    ...
    if args.render_only:
        ...
        with torch.no_grad():
            ...
            print(f'Throughput: {NUM_ITERS * BATCH_SIZE / float(t1 - t0):.2f} samp/sec')
            if MODE == 'prof':
                print(prof \
